...
import { MousePointer2, Zap, FileText, MessageSquare, CheckCircle2, Check } from 'lucide-react';

/* ====================================
   1. Input Step Components
   ==================================== */
const TypingDoc = ({ title, color, idx, posClass, zIndex, scrollYProgress }) => {
...
const Phase3 = () => {
  ...
  const inputDocs = [
    { title: "소싱관리 주간보고.docx", color: "bg-blue-500", idx: 0, posClass: "top-0 left-0", zIndex: "z-10" },
    { title: "구매관리 주간보고.docx", color: "bg-blue-600", idx: 1, posClass: "top-12 left-8", zIndex: "z-20" },
    { title: "전사경영기획 주간보고.docx", color: "bg-blue-700", idx: 2, posClass: "top-24 left-16", zIndex: "z-30" },
    { title: "통합경영기획 주간보고.docx", color: "bg-blue-800", idx: 3, posClass: "top-36 left-24", zIndex: "z-40" },
  ];
  ...
  const sourceDocs = [
    { color: "text-blue-500", bg: "bg-blue-100", border: "border-blue-200", startX: -250, startY: -100 },
    { color: "text-blue-600", bg: "bg-blue-200", border: "border-blue-300", startX: 250, startY: -50 },
    { color: "text-blue-700", bg: "bg-blue-300", border: "border-blue-400", startX: -200, startY: 150 },
    { color: "text-blue-800", bg: "bg-blue-400", border: "border-blue-500", startX: 200, startY: 100 },
  ];
        ...
        >
          ...
          <div className="z-10 text-left max-w-xl md:w-1/2">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 leading-tight mb-6">
              금요일 오후 4시,<br/>
              평소처럼 자신의 <span className="text-blue-600">구글 독스</span>에만 작성하면 됩니다.
            </h2>
            <p className="text-lg text-slate-600 leading-relaxed">
              새로운 툴을 배울 필요조차 없습니다. 기존에 익숙한 방식 그대로 본인에게 할당된 문서에 주간 업무 내용을 타이핑하기만 하면 됩니다.
            </p>
          </div>
        ...
        >
          <div className="z-10 text-left max-w-xl md:w-1/2">
            ...
            <p className="text-lg text-slate-600">
              앱스크립트가 각기 다른 파일로 흩어진 데이터를 자동으로 탐색, 취합, 정제하여 하나의 마스터 뷰로 통합합니다.
            </p>
          </div>
            ...
            <div className="w-full bg-white border border-slate-100 rounded-lg flex flex-col md:flex-row p-4 gap-6 shadow-sm">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="flex justify-center gap-3 mt-3 text-[10px] text-slate-600 font-medium whitespace-nowrap">
                  <span className="flex items-center gap-1"><div className="w-2h-2 bg-rose-400 rounded-sm"></div> 매출액</span>
                  <span className="flex items-center gap-1"><div className="w-2h-2 bg-amber-400 rounded-sm"></div> 매출원가</span>
                </div>
              </div>
