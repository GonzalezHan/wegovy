...
const phases = [
  {
    phase: "Roadmap 01",
    title: "Data Pipeline",
    description: "흩어진 문서, 시트, 폼 데이터를 표준화된 파이프라인으로 연결해 취합부터 검증까지 자동화합니다.",
    icon: Zap,
  ...
  },
  {
    phase: "Roadmap 02",
    title: "AI Agent",
    description: "정형 보고를 넘어 요약, 검토, 이상 징후 탐지까지 돕는 AI 기반 업무 에이전트를 단계적으로 도입합니다.",
    icon: ShieldCheck,
  ...
  },
  {
    phase: "Roadmap 03",
    title: "Integration",
    description: "ERP, 외부 금융 API, 사내 협업 도구를 하나의 흐름으로 묶어 데이터 정합성과 실시간성을 높입니다.",
    icon: Rocket,
  ...
  },
  {
    ...
    description: "데이터 취합 이후의 보고서 생성과 배포까지 이어지는 완전 자동 리포팅 체계를 구축합니다.",
    icon: Bot,
...
const Roadmap = () => {
  return (
    <section className="h-full w-full flex flex-col justify-center relative overflow-hidden bg-transparent text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8 w-full flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="w-full lg:w-1/2 flex flex-col space-y-8">
          <div className="space-y-4">
            ...
            <p className="opacity-70 text-lg">자동화 TF의 다음 단계는 데이터 흐름과 보고 체계 자체를 새로 설계하는 것입니다.</p>
          </div>
